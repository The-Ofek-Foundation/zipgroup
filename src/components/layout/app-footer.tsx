...
export function AppFooter({ onCreateNewPage }: AppFooterProps) {
  return (
    <footer className="py-6 text-center text-sm text-muted-foreground border-t">
      <div className="flex items-center justify-center gap-1 flex-wrap px-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-0 h-auto text-sm font-normal text-muted-foreground hover:text-primary hover:underline flex items-center"
        >
          Gemini
          <svg
          ...
          >
            <path
              ...
              fill="url(#paint0_radial_gemini_footer_actual_page)"
            />
            <defs>
              <radialGradient
                id="paint0_radial_gemini_footer_actual_page"
                cx="0"
                cy="0"
                r="1"
